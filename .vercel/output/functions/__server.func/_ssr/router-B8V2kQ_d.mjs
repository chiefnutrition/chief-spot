...
import { $t as isTest, A as base64Url, At as ATTR_HOOK_TYPE, Bt as initGetModelName, C as runWithEndpointContext, D as serializeSignedCookie, E as serializeCookie, Ft as getCurrentAdapter, Gt as logger, Ht as generateId, It as queueAfterTransactionHook, Jt as env, Kt as shouldPublishLog, Lt as runWithAdapter, M as decodeProtectedHeader, Mt as import_src, N as jwtVerify, Nt as safeJSONParse, O as filterOutputFields, Ot as withSpan, Pt as getAuthTables, Qt as isProduction, Rt as runWithTransaction, S as getCurrentAuthContext, T as toResponse, Ut as createRandomStringGenerator, Vt as initGetFieldName, Wt as createLogger, Zt as isDevelopment, _ as createAuthMiddleware, _n as record, a as betterFetch, b as hasRequestState, c as applyDefaultAccessTokenExpiry, cn as any, d as findInvalidTrustedProxies, dn as email, en as APIError, f as getIp, fn as literal, g as createAuthEndpoint, gn as optional, h as normalizePathname, hn as object, i as refreshAccessToken, in as defineErrorCodes, j as decodeJwt, jt as ATTR_OPERATION_ID, kt as ATTR_CONTEXT, l as isLoopbackHost, ln as array, mn as number, mt as JWTExpired, n as socialProviders, nn as kAPIErrorHeaderSymbol, nt as encode, p as deprecate, pn as looseObject, r as validateAuthorizationCode, rn as BASE_ERROR_CODES, s as createAuthorizationURL, t as SocialProviderListEnum, tn as BetterAuthError, u as createRateLimitKey, un as boolean, v as isAPIError, vn as string, w as createRouter$1, x as runWithRequestState, y as defineRequestState, yn as union, zt as getBetterAuthVersion } from "../_libs/@better-auth/core+[...].mjs";
import { n as string$1, t as boolean$1 } from "../_libs/zod.mjs";
import { n as ensureDbReady, r as getPglite } from "./db-BmoIekU4.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B8V2kQ_d.js
...
var styles_default = "/assets/styles-C5YX-qhS.css";
var APP_NAME = "Spot the Junk";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Spot the junk. Pick 3 ingredients you'd never find in a Chief product — then claim a prize."
			}
		],
		links: [
			{
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					...
					toastOptions: { style: {
						background: "#211a15",
						color: "#f3ebe1",
						border: "1px solid color-mix(in oklab, #f3ebe1 14%, transparent)"
					} }
				}),
...
var $$splitComponentImporter$2 = () => import("./routes-CR2Xqk1_.mjs");
function flag(value) {
...
var $$splitComponentImporter$1 = () => import("./login-RawCWFKg.mjs");
var Route$2 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./shopify-CfFf0fF2.mjs");
var Route$1 = createFileRoute("/shopify")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
/**
...
//#endregion
export { getBaseURL as a, PACKAGE_VERSION as i, GROK_PROVIDERS as n, Route$3 as o, GENERIC_OAUTH_ERROR_CODES as r, router_exports as t };
