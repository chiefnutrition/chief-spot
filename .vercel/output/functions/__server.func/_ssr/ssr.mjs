...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CeUf1T7w.mjs");
...
var manifest = {
	"965a7b6cc415d56e8f67dcbc34cfcb6bd84b8cc728c34ddac13d1d5e79d8e97e": {
		functionName: "claimPrize_createServerFn_handler",
		importer: () => import("./actions-BrH4rRmA.mjs")
	},
	"fe269277aefdc47a8e52011058da31d45c0b7ec146fe74c923ce00c7a5839a38": {
		functionName: "getKlaviyoStatus_createServerFn_handler",
		importer: () => import("./actions-BrH4rRmA.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B8V2kQ_d.mjs").then((n) => n.t),
...
//#endregion
export { ssr_exports as a, createServerEntry, server_default as default, getServerFnById as i, createServerFn as n, __exportAll as o, TSS_SERVER_FUNCTION as r, server_exports as t };
